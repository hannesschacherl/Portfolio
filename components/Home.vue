            ...
            >
                ...
                >
                    ...
                    <div class="dark:text-white w-full h-full md:text-xl">
                        ...
                        Molestiae rerum sed illum officia, voluptatum cum error,
                        repellendus placeat at beatae reprehenderit corrupti
                        pariatur. Dolorum facere provident itaque maxime numquam
                        laborum.
                    </div>
                </div>
                <a
                ...
                <div
                    class="container6 transform -translate-x-24 opacity-0 p-4 rounded-2xl bg-white shadow-md dark:bg-[#3D3D3D] hidden md:block md:row-span-2 md:col-span-2 h-full"
                >
                    <div
                        class="text-4xl text-black dark:text-white font-bold select-none"
                    >
